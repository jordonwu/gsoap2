...
@brief This module defines the `::soap` \ref soap "context structure with the engine state" with API functions to allocate, initialize, copy, and delete contexts

View the \ref soap "context structure with the engine state" (a separate page) for more details on the context structure member variables.  The member variables used in this page and elsewhere in the documentation are hyperlinked.  Most structure member variables may be changed directly as is documented with illustrative examples.
...
@see `#WITH_IPV6`, `#WITH_IPV6_V6ONLY`, `#SOAP_IO_UDP`, `#SOAP_IO_CHUNK`, `#SOAP_IO_STORE`, `#SOAP_IO_KEEPALIVE`, `::soap::accept_flags`, `::soap::bind_flags`, `::soap::bind_inet6`, `::soap::bind_v6only`, `::soap::rcvbuf`, `::soap::sndbuf`, `::soap::master`, `::soap_bind`, `::soap_ssl_accept`.
@see `#SOAP_IO_CHUNK`, `#SOAP_IO_STORE`, `#SOAP_IO_KEEPALIVE`, `#SOAP_MAXKEEPALIVE`, `::soap::connect_flags`, `::soap::connect_timeout`.
*/
int soap_connect(
    struct soap *soap,    ///< `::soap` context
    const char *endpoint, ///< URL string
...
@see `#WITH_IPV6`, `#WITH_IPV6_V6ONLY`, `#SOAP_IO_UDP`, `#SOAP_IO_CHUNK`, `#SOAP_IO_STORE`, `#SOAP_IO_KEEPALIVE`, `#SOAP_MAXKEEPALIVE`, `::soap::accept_flags`, `::soap::bind_flags`, `::soap::bind_inet6`, `::soap::bind_v6only`, `::soap::rcvbuf`, `::soap::sndbuf`, `::soap::master`, `::soap_bind`, `::soap_ssl_accept`.
*/
